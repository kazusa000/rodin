...
#pragma omp single
  ...
  class OpenMP<LinearSystem, Variational::Problem<LinearSystem, TrialFunction, TestFunction>>
    : public AssemblyBase<LinearSystem, Variational::Problem<LinearSystem, TrialFunction, TestFunction>>
  {
    public:
       ...
       * @param other OpenMP assembly to copy
       */
      OpenMP(const OpenMP& other)
        : Parent(other)
      {}
       ...
       * @param other OpenMP assembly to move
       */
      OpenMP(OpenMP&& other)
        : Parent(std::move(other))
      {}
       ...
       * @return OpenMP* Pointer to a new copy
       */
      OpenMP* copy() const noexcept override
      {
        return new OpenMP(*this);
